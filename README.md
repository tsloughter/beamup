...
```
curl --proto '=https' --tlsv1.2 -LsSf https://github.com/tsloughter/beamup/releases/download/v0.7.2/beamup-installer.sh | sh
```
...
```
powershell -c "irm
https://github.com/tsloughter/beamup/releases/download/v0.7.2/beamup-installer.ps1
| iex"
```
